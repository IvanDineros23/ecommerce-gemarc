...
<style>
    ...
    #inquiryForm .btn-success.w-100:hover{transform:translateY(-1px);box-shadow:0 14px 28px rgba(46,125,50,.32)}
...
@section('content')
    ...
    <!-- Success toast (same behavior as Aggregates) -->
    @if(session('success'))
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-contact-section">
                    ...
                    <!-- IMPORTANT: This now POSTS to your backend like Aggregates -->
    ...
    function openProductModal(product){
        ...
        // Set inquiry product (will be submitted)
        ...
        if(product.specs && product.specs.length){
            ...
            specsGrid.innerHTML = '<p>No detailed specifications available. Please refer to the PDF or contact us.</p>';
        }
    ...
    // === Product openers (same as your original) ===
